<?php session_start();
	...
	$totalq="select count(*) \"total\" from book where writer='jafar iqbal'";
...
<body>
		...
		<div class="col-md-5 text-center">
			<h1 class="title">Books of Jafar Iqbal </h1>
									...
									<div class="singel_book">
										<table  class="table" >
											...
											<?php
												...
												$query="select *from book where writer='jafar iqbal' LIMIT ".$k .",".$page_per_page;
