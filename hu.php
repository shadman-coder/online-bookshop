<?php session_start();
	...
	$totalq="select count(*) \"total\" from book where writer='humayun ahmed'";
...
<body>
		...
		<div class="col-md-5 text-center">
			<h1 class="title">Books of Humayun Ahmed </h1>
									...
									<div class="singel_book">
										<table  class="table" >
											...
											<?php
												...
												$query="select *from book where writer='humayun ahmed' LIMIT ".$k .",".$page_per_page;
