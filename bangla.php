<?php session_start();
	...
	$totalq="select count(*) \"total\" from book where b_publisher='bangla academi'";
...
<body>
		...
		<div class="col-md-5 text-center">
			<h1 class="title">Books of Bangla Academy </h1>
									...
									<div class="singel_book">
										<table  class="table" >
											...
											<?php
												...
												$query="select *from book where b_publisher='bangla academi' LIMIT ".$k .",".$page_per_page;
