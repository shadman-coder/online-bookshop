<?php session_start();
	...
	$totalq="select count(*) \"total\" from book where b_publisher='somyo prokason'";
...
<body>
		...
		<div class="col-md-5 text-center">
			<h1 class="title">Books of Somyo Prokashon </h1>
									...
									<div class="singel_book">
										<table  class="table" >
											...
											<?php
												...
												$query="select *from book where b_publisher='somyo prokason' LIMIT ".$k .",".$page_per_page;
